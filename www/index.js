...
function index (a, b) {
  ...
  for (var i = 1; i < dim; i++) {
    for (var j = 1; j < dim; j++) {
      C[i * dim + j] = Math.max(Math.min(C[(i - 1) * dim + j], C[(i - 1) * dim + j - 1], C[i * dim + j - 1]), dist(a[i], b[j]));
    }
  }
...
},{"hammerjs":3}],8:[function(require,module,exports){
...
var _sentence = require('./sentence.vue');

var _sentence2 = _interopRequireDefault(_sentence);

var _kanjiInput = require('./kanji-input.vue');
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/home/andreas/Documents/kanjily/src/components/game.vue"
  if (!module.hot.data) {
...
exports.Game = exports.Sentence = exports.KanjiInput = undefined;
...
var _game = require('./game.vue');

var _game2 = _interopRequireDefault(_game);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.KanjiInput = _kanjiInput2.default;
exports.Sentence = _sentence2.default;
exports.Game = _game2.default;

},{"./game.vue":10,"./kanji-input.vue":12,"./sentence.vue":13}],12:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert(".kanji-input__svg {\n  border: 2px solid #000;\n}\n.kanji-input__cross {\n  fill: none;\n  stroke-width: 1;\n  stroke: rgba(0,0,0,0.2);\n  stroke-dasharray: 4, 1;\n}\n.kanji-input__guide {\n  stroke-width: 2;\n  stroke: #808080;\n  fill: none;\n}\n.kanji-input__strokes {\n  stroke-width: 3;\n  stroke: #000;\n  fill: none;\n}\n.kanji-input__strokes__stroke {\n  -webkit-transition: all 0.2s ease-in-out;\n  transition: all 0.2s ease-in-out;\n  opacity: 1;\n  -webkit-transform-origin: 50% 50%;\n          transform-origin: 50% 50%;\n  -webkit-transform: scale(1);\n          transform: scale(1);\n}\n.kanji-input__strokes__stroke--hidden {\n  opacity: 0;\n  -webkit-transform: scale(1.2);\n          transform: scale(1.2);\n}\n.kanji-input__user {\n  stroke-width: 3;\n  stroke: #000;\n  stroke-linecap: round;\n  fill: none;\n}\n")
'use strict';
...
var _frechet = require('frechet');

var _frechet2 = _interopRequireDefault(_frechet);
...
exports.default = {
  ...
  ready: function ready() {
    this.svg = _d2.default.select(this.$els.userPath);
    this.line = _d2.default.svg.line().interpolate('basis');
  ...
  computed: {
    hex: function hex() {
      return _util2.default.charToHex(this.kanji);
    },
  ...
  watch: {
    ...
    currentStroke: function currentStroke() {
      if (this.finished) {
  ...
  methods: {
    onKanjiChange: function onKanjiChange(kanji) {
      var _this = this;

      return _util2.default.fetchKanji(kanji).then(_util2.default.parseSvg).then(function (strokes) {
        _this.strokes = strokes;
        _this.currentStroke = 0;
        _this.coordinates = [];
        _this.onCoordinateChange();
      }, function (error) {
        console.error(error);
      });
    },
    ...
    onPanStart: function onPanStart(e) {
      ...
      var x = e.center.x - this.position.left;
      var y = e.center.y - this.position.top;
    ...
    onPan: function onPan(e) {
      ...
      this.coordinates = _util2.default.simplify(this.coordinates, 0.3);
    ...
    onCoordinateChange: function onCoordinateChange() {
      this.svg.data([this.coordinates]).attr('d', this.line);
    },

    compare: function compare() {
      var l1 = _util2.default.samplePath(this.strokes[this.currentStroke], this.coordinates.length);
      var l2 = this.coordinates;

      if ((0, _frechet2.default)(l1, l2) < 25) {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<svg class=\"kanji-input__svg\" xmlns=\"http://www.w3.org/2000/svg\" width=\"109\" height=\"109\" viewBox=\"0 0 109 109\" v-touch:panstart=\"onPanStart($event)\" v-touch:panend=\"onPanEnd($event)\" v-touch:pan=\"onPan($event)\" v-el:svg=\"\">\n  <g class=\"kanji-input__cross\">\n    <path d=\"M54.5 0 l0 109\"></path>\n    <path d=\"M0 54.5 l109 0\"></path>\n  </g>\n  <g class=\"kanji-input__guide\" v-if=\"showGuide\">\n    <path v-for=\"stroke in strokes\" :d=\"stroke\">\n    </path>\n  </g>\n  <g class=\"kanji-input__strokes\">\n    <path v-for=\"stroke in strokes\" class=\"kanji-input__strokes__stroke\" v-bind:class=\"{'kanji-input__strokes__stroke--hidden': currentStroke <= $index}\" :d=\"stroke\">\n    </path>\n  </g>\n  <g class=\"kanji-input__user\">\n    <path v-el:user-path=\"\"></path>\n  </g>\n</svg>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/andreas/Documents/kanjily/src/components/kanji-input.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache[".kanji-input__svg {\n  border: 2px solid #000;\n}\n.kanji-input__cross {\n  fill: none;\n  stroke-width: 1;\n  stroke: rgba(0,0,0,0.2);\n  stroke-dasharray: 4, 1;\n}\n.kanji-input__guide {\n  stroke-width: 2;\n  stroke: #808080;\n  fill: none;\n}\n.kanji-input__strokes {\n  stroke-width: 3;\n  stroke: #000;\n  fill: none;\n}\n.kanji-input__strokes__stroke {\n  -webkit-transition: all 0.2s ease-in-out;\n  transition: all 0.2s ease-in-out;\n  opacity: 1;\n  -webkit-transform-origin: 50% 50%;\n          transform-origin: 50% 50%;\n  -webkit-transform: scale(1);\n          transform: scale(1);\n}\n.kanji-input__strokes__stroke--hidden {\n  opacity: 0;\n  -webkit-transform: scale(1.2);\n          transform: scale(1.2);\n}\n.kanji-input__user {\n  stroke-width: 3;\n  stroke: #000;\n  stroke-linecap: round;\n  fill: none;\n}\n"] = false
...
exports.parseJapanese = exports.samplePath = exports.simplify = exports.parseSvg = exports.fetchKanji = exports.charToHex = undefined;
...
var charToHex = exports.charToHex = function charToHex(char) {
  return ('00000' + char.charCodeAt(0).toString('16')).slice(-5);
};

var fetchKanji = exports.fetchKanji = function fetchKanji(kanji) {
...
var parseSvg = exports.parseSvg = function parseSvg(data) {
  var div = document.createElement('div');
  div.innerHTML = data.svg;

  var strokes = Array.from(div.querySelectorAll('path[id^="kvg:' + charToHex(data.kanji) + '-s"]')).map(function (path) {
...
var simplify = exports.simplify = function simplify(points) {
  ...
  return _simplifyJs2.default.apply(undefined, [points].concat(args)).map(function (p) {
    return [p.x, p.y];
  });
};

var samplePath = exports.samplePath = function samplePath(d, n) {
  ...
  for (var i = 0; i < n; i++) {
    var pt = path.getPointAtLength(part * i);
    rv.push([pt.x, pt.y]);
  }
...
var parseJapanese = exports.parseJapanese = function parseJapanese(str) {};
